...
| | The Home page displays 3 cards that feature different aspects of the products available, the Clearance section to encourage users to shop for deals, the Horror/Mystery section as it's a section I enjoy, and the Best Seller of the Month. Each image is clickable and brings the user to the relevant section described in the text shown | ![Book Features](/docs/images/book-features.png) |
